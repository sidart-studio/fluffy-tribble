...
| `food_worker.glb` | Food Worker | J-Toastie | CC-BY 3.0 | The cashier |
| `retail_worker.glb` | Retail Worker | J-Toastie | CC-BY 3.0 | Runners who carry plates |
...
- Keys the game knows: `register`, `cashStack`, `cashier`, `runner`, `kitchen`, `cabinet`, `knife`, `chef`.
